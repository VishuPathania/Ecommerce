...
import { Link } from 'react-router-dom';
 ...
 function SignUp() {
  ...
  const passwordref = useRef(); // Changed variable name to match the references in the form
  const confirmpasswordref = useRef();
  
  const submithandler = (e) => {
    e.preventDefault();
    const enteredemail = emailref.current.value;
    const enteredpassword = passwordref.current.value; // Changed variable name
